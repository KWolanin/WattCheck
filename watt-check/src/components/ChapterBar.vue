  ...
  <a :href="chapter.link" target="_blank"
    ...
    <div class="flex items-center space-x-2 max-w-[70%] overflow-hidden">
      ...
      <span class="flex space-x-2 text-xs text-white">
        ...
        <!-- Stars: gwiazdka -->
        <span class="flex items-center bg-amber-500 rounded px-2 py-0.5 space-x-1">
        ...
        <!-- Comments: dymek komentarza -->
        <span class="flex items-center bg-sky-700 rounded px-2 py-0.5 space-x-1">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"
            stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round"
